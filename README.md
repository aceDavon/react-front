...
**Rails React Front** Rails React Front is bulit to practice working with Rails and React as front-end. This project was built to satisfy the Microverse Module 6 block 1 requirement and is MIT Licensed.
...
- Clone this repo to your local machine
  -  `git clone git@github.com:aceDavon/react-front.git
`
